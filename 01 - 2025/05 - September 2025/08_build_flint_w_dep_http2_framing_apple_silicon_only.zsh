...
# Set Apple Silicon environment variables - FIXED
setup_apple_silicon_env() {
    ...
    # FIXED: Use arrays for proper flag handling
    CFLAGS_ARRAY=(
        "-arch" "arm64"
        "-isysroot" "$sdk_path"
...
# FIXED: Enhanced compiler test using arrays
test_compiler() {
...
EOF
    ...
    # Test compilation using array expansion (FIXED)
